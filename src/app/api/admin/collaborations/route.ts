...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    let backendUrl = `${BACKEND_URL}/api/admin/collaborations?page=${page}&limit=${limit}`;
    if (approvalStatus) {
...
export async function PUT(request: NextRequest) {
  ...
  try {
    // Extract collaborationId from the URL
    ...
    const backendUrl = isApprove
      ? `${BACKEND_URL}/api/admin/collaborations/${collaborationId}/approve`
      : `${BACKEND_URL}/api/admin/collaborations/${collaborationId}/reject`;
