...
import AuthGate from "../../../../components/admin/cms/AuthGate";
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded shadow p-5">
              <div className="flex items-center justify-between mb-3">
                ...
                <Link className="text-sm text-fixnix-lightpurple" href="/admin/cms/editor">
                  Edit
                </Link>
              </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded shadow p-5 space-y-3">
          ...
          <Link
            href="/admin/cms/dashboard/upload"
            className="inline-block bg-purple-400 text-white px-3 py-2 rounded"
          >
            Go to Bulk Upload
          </Link>
